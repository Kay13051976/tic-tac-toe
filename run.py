...
In with an empty three multiply three grid.
This grid consists of three rows and three columns,
...
- You can stop or continue to play by selecting a simple
  menu using the arrow up and down to enter Play Again or Quit.

      """)

    def print_board(self):
        """ print board method to print out the first board """
        formatted_board_lines = ['| ' + ' | '.join(self.board[
    ...
    def winner(self, square, letter):
        ...
        # (0, 2, 4, 6, 8)(These are the only moves possible to win a diagonal)
        if square % 2 == 0:
...
def play(game, x_player, o_player, print_game=True):
    ...
    # Iterate while the game still has empty squares, return the winner name
    # using return statement to break out the loop
...
if __name__ == '__main__':
    # Import human player nad random computer player
    # from player file to the top of the page first
